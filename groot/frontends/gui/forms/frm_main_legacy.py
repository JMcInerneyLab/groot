...
class FrmMain( QMainWindow, ILegoViewModelObserver, IGuiPluginHostWindow ):
    ...
    @exqtSlot()
    def on_ACT_SELECT_BY_NAME_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_BY_NAME' does not appear in the designer file.
        """
        Signal handler:
        """
        pass
    ...
    @exqtSlot( bool )
    def on_ACT_SELECT_LEFT_triggered( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_LEFT' does not appear in the designer file.
        """
    ...
    @exqtSlot( bool )
    def on_ACT_SELECT_RIGHT_triggered( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_RIGHT' does not appear in the designer file.
        """
    ...
    @exqtSlot( bool )
    def on_ACT_SELECT_DIRECT_CONNECTIONS_triggered( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_DIRECT_CONNECTIONS' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_FILE_NEW_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_FILE_NEW' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_FILE_IMPORT_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_FILE_IMPORT' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_FILE_SAVE_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_FILE_SAVE' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_FILE_SAVE_AS_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_FILE_SAVE_AS' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_FILE_EXPORT_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_FILE_EXPORT' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_VIEW_ALIGN_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_VIEW_ALIGN' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_VIEW_ALIGN_SUBSEQUENCES_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_VIEW_ALIGN_SUBSEQUENCES' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_VIEW_ALIGN_FIRST_SUBSEQUENCES_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_VIEW_ALIGN_FIRST_SUBSEQUENCES' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_MODIFY_CLEAN_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_CLEAN' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_MODIFY_SET_TREE_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_SET_TREE' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_MODIFY_SET_ALIGNMENT_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_SET_ALIGNMENT' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_MODIFY_QUANTISE_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_QUANTISE' does not appear in the designer file.
        """
        Signal handler:
        """
        pass  # TODO: REMOVE
    ...
    @exqtSlot()
    def on_ACT_REFRESH_VIEW_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_REFRESH_VIEW' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_UPDATE_VIEW_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_UPDATE_VIEW' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_DEBUG_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_DEBUG' does not appear in the designer file.
        """
        Signal handler:
        """
        pass
    ...
    @exqtSlot()
    def on_BTN_STATUS_FILE_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_FILE' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_STATUS_BLAST_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_BLAST' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_STATUS_FASTA_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_FASTA' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_STATUS_COMPONENTS_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_COMPONENTS' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_STATUS_ALIGNMENTS_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_ALIGNMENTS' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_BTN_STATUS_TREES_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_TREES' does not appear in the designer file.
        """
        Signal handler:
        """
        selected = menu_helper.show( self.sender(), "Generate", "Drop", "View" )
    ...
    @exqtSlot()
    def on_BTN_STATUS_FUSIONS_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_FUSIONS' does not appear in the designer file.
        """
        Signal handler:
        """
        pass
    ...
    @exqtSlot()
    def on_BTN_STATUS_NRFG_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_STATUS_NRFG' does not appear in the designer file.
        """
        Signal handler:
        """
        self._update_status_checkbox_values()
        ...
        if selected == "Generate":
            ...
            self.request_plugin( COMMANDS.ext_viewing.print_trees, self._model.nrfg, COMMANDS.ext_viewing.EFormat.VISJS )
    
    
    @exqtSlot()
    def on_BTN_VIEW_SETTINGS_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_VIEW_SETTINGS' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_SEL_COMPONENT_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_SEL_COMPONENT' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_BTN_SEL_EDGE_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_SEL_EDGE' does not appear in the designer file.
        """
        Signal handler:
        """
        self.change_selection_mode()
    ...
    @exqtSlot()
    def on_BTN_SEL_SEQUENCE_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_SEL_SEQUENCE' does not appear in the designer file.
        """
        Signal handler:
        """
        self.change_selection_mode()
    ...
    @exqtSlot()
    def on_BTN_SEL_SUBSEQUENCE_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'BTN_SEL_SUBSEQUENCE' does not appear in the designer file.
        """
        Signal handler:
        """
        self.change_selection_mode()
    ...
    @exqtSlot()
    def on_ACT_MODIFY_NEW_ENTITY_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_NEW_ENTITY' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_MODIFY_REMOVE_ENTITY_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_MODIFY_REMOVE_ENTITY' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_CHKBTN_DATA_BLAST_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_BLAST' does not appear in the designer file.
        """
        Signal handler:
        """
        pass
    ...
    @exqtSlot()
    def on_CHKBTN_DATA_DATA_clicked( self ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_DATA' does not appear in the designer file.
        """
        Signal handler:
        """
        pass
    ...
    @exqtSlot( bool )
    def on_CHKBTN_DATA_FASTA_clicked( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_FASTA' does not appear in the designer file.
        """
    ...
    @exqtSlot( bool )
    def on_CHKBTN_DATA_NEWICK_clicked( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_NEWICK' does not appear in the designer file.
        """
        Signal handler: No action
        """
        pass
    ...
    @exqtSlot( bool )
    def on_CHKBTN_DATA_FASTA_toggled( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_FASTA' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot( bool )
    def on_CHKBTN_DATA_NEWICK_toggled( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'CHKBTN_DATA_NEWICK' does not appear in the designer file.
        """
    ...
    @exqtSlot( bool )
    def on_ACT_APP_EXIT_triggered( self, _: bool ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_APP_EXIT' does not appear in the designer file.
        """
    ...
    @exqtSlot()
    def on_ACT_HELP_KEYS_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_HELP_KEYS' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_SELECT_ALL_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_ALL' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_SELECT_NONE_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_NONE' does not appear in the designer file.
        """
        Signal handler:
        """
        self.model_view.select_all( ESelect.REMOVE )
    ...
    @exqtSlot()
    def on_ACT_SELECT_EMPTY_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECT_EMPTY' does not appear in the designer file.
        """
        Signal handler:
        """
    ...
    @exqtSlot()
    def on_ACT_SELECTION_INVERT_triggered( self ) -> None: #TODO: BAD_HANDLER - The widget 'ACT_SELECTION_INVERT' does not appear in the designer file.
        """
        Signal handler:
        """

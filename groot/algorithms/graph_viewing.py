...
from groot.data.lego_model import ILeaf, LegoComponent, LegoSequence
...
def create_vis_js( format_str, graphs: Sequence[MGraph], model, inline_title = True, title : str = None ) -> str:
    if inline_title:

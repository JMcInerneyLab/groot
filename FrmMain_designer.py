...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BTN_WHATS_THIS.sizePolicy().hasHeightForWidth())
        self.BTN_WHATS_THIS.setSizePolicy(sizePolicy)
        self.BTN_WHATS_THIS.setMinimumSize(QtCore.QSize(32, 32))
        self.BTN_WHATS_THIS.setMaximumSize(QtCore.QSize(32, 32))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Images/help-cursor.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_WHATS_THIS.setIcon(icon)
        self.BTN_WHATS_THIS.setObjectName("BTN_WHATS_THIS")
        self.horizontalLayout_2.addWidget(self.BTN_WHATS_THIS)
        ...
        self.RAD_OPT_NONE = QtWidgets.QRadioButton(self.frame)
        self.RAD_OPT_NONE.setObjectName("RAD_OPT_NONE")
        self.verticalLayout.addWidget(self.RAD_OPT_NONE)
        self.RAD_OPT_MC = QtWidgets.QRadioButton(self.frame)
        self.RAD_OPT_MC.setObjectName("RAD_OPT_MC")
        self.verticalLayout.addWidget(self.RAD_OPT_MC)
        self.RAD_OPT_ALL = QtWidgets.QRadioButton(self.frame)
        self.RAD_OPT_ALL.setObjectName("RAD_OPT_ALL")
        self.verticalLayout.addWidget(self.RAD_OPT_ALL)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BTN_WHATS_THIS.setToolTip(_translate("MainWindow", "Click to display \"what\'s this\" style popup help."))
        self.BTN_WHATS_THIS.setStatusTip(_translate("MainWindow", "Click to display \"what\'s this\" style popup help."))
        ...
        self.label_4.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Select the optimisation method.</p><p><br/></p><p><span style=\" font-weight:600;\">None</span></p><p>Don\'t optimise, sequences will be sorted by length.</p><p>This is the fastest option.</p><p>Takes less than a second with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">Monte carlo</span></p><p>Quick and dirty optimisation over a subset of random permutaions.</p><p>Takes a few seconds with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">All</span></p><p>Optimise over all permutations. May take an excessively long time.</p><p>Takes overnight with the sample data.</p></body></html>"))
        self.label_4.setText(_translate("MainWindow", "Optimise over"))
        self.RAD_OPT_NONE.setStatusTip(_translate("MainWindow", "Sort sequences by length"))
        self.RAD_OPT_NONE.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Select the optimisation method.</p><p><br/></p><p><span style=\" font-weight:600;\">None</span></p><p>Don\'t optimise, sequences will be sorted by length.</p><p>This is the fastest option.</p><p>Takes less than a second with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">Monte carlo</span></p><p>Quick and dirty optimisation over a subset of random permutaions.</p><p>Takes a few seconds with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">All</span></p><p>Optimise over all permutations. May take an excessively long time.</p><p>Takes overnight with the sample data.</p></body></html>"))
        self.RAD_OPT_NONE.setText(_translate("MainWindow", "None"))
        self.RAD_OPT_MC.setStatusTip(_translate("MainWindow", "Run a quick Montecarlo simulation to optimise the order"))
        self.RAD_OPT_MC.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Select the optimisation method.</p><p><br/></p><p><span style=\" font-weight:600;\">None</span></p><p>Don\'t optimise, sequences will be sorted by length.</p><p>This is the fastest option.</p><p>Takes less than a second with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">Monte carlo</span></p><p>Quick and dirty optimisation over a subset of random permutaions.</p><p>Takes a few seconds with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">All</span></p><p>Optimise over all permutations. May take an excessively long time.</p><p>Takes overnight with the sample data.</p></body></html>"))
        self.RAD_OPT_MC.setText(_translate("MainWindow", "Monte carlo"))
        self.RAD_OPT_ALL.setStatusTip(_translate("MainWindow", "Optimise the order over all permutaions **very slow**"))
        self.RAD_OPT_ALL.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Select the optimisation method.</p><p><br/></p><p><span style=\" font-weight:600;\">None</span></p><p>Don\'t optimise, sequences will be sorted by length.</p><p>This is the fastest option.</p><p>Takes less than a second with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">Monte carlo</span></p><p>Quick and dirty optimisation over a subset of random permutaions.</p><p>Takes a few seconds with the sample data.</p><p><br/></p><p><span style=\" font-weight:600;\">All</span></p><p>Optimise over all permutations. May take an excessively long time.</p><p>Takes overnight with the sample data.</p></body></html>"))
        self.RAD_OPT_ALL.setText(_translate("MainWindow", "All (slow)"))
        ...
        self.label_5.setText(_translate("MainWindow", "This application is still in early development"))

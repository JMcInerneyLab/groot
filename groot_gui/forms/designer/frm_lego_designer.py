...
"border-bottom: 1px solid black;")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/groot/maximize.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_SHOW_EDIT.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/groot/remove.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_DELETE_GENE.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/groot/outgroup.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_OUTGROUP_GENE.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/groot/save_as.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_RENAME_GENE.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/groot/import_.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BTN_COMPONENT_GENE.setIcon(icon12)
...
"text-transform: uppercase;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.BTN_S_DOMAINS_.setText(_translate("Dialog", "Domains"))
